 ...
 */
package com.vivo.baiduaidemo.ocr;
...
import com.vivo.baiduaidemo.Authority;
import com.vivo.baiduaidemo.R;
...
public class OCRMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.general_basic_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(OCRMainActivity.this, CameraActivity.class);
        ...
        findViewById(R.id.idcard_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(OCRMainActivity.this, IDCardActivity.class);
    ...
    private void initAccessTokenWithAkSk() {
        ...
        }, getApplicationContext(), Authority.APP_KEY, Authority.SECRET_KEY);
    }
